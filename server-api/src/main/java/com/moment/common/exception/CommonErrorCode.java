...
public enum CommonErrorCode implements ErrorCode {
		...
		UNSUPPORTED_TOKEN(HttpStatus.UNAUTHORIZED.value(), "지원되지 않는 JWT 토큰입니다."),
		WRONG_TOKEN(HttpStatus.UNAUTHORIZED.value(), "잘못된 JWT 토큰입니다."),
		INVALID_TOKEN(HttpStatus.UNAUTHORIZED.value(), "유효하지 않는 JWT 서명입니다.")
	;
